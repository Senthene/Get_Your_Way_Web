$(document).ready(function() {
    ...
    $('#input-file-chooser').change(function() {
        document.getElementById("etape-5").style="block";
        document.getElementById("step-3").className = "col-xs-3 bs-wizard-step complete";
        document.getElementById("etape-6").style="block";
        ...
        $(new FileReader()).load(function(event) {
            ...
            switch (fileExtension) {
                case 'dxf':
                    ...
                    var div = document.getElementById('segmentation-notification');
